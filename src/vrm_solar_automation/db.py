...
class ControllerStateRecord(Base):
    ...
    plug_mismatch_alert_sent: Mapped[bool] = mapped_column(BOOLEAN, nullable=False, default=False)
    ...
    weather_cache_today_sunrise_iso: Mapped[str | None] = mapped_column(String(40))
    weather_cache_tomorrow_sunrise_iso: Mapped[str | None] = mapped_column(String(40))
    weather_cache_today_sunset_iso: Mapped[str | None] = mapped_column(String(40))
    weather_cache_tomorrow_sunset_iso: Mapped[str | None] = mapped_column(String(40))
...
class ControlCycleRecord(Base):
    ...
    night_solar_crossover_local: Mapped[str | None] = mapped_column(String(5))
    night_solar_crossover_source: Mapped[str | None] = mapped_column(String(16))
